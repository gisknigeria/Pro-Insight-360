          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2.5 text-sm font-bold text-slate-900 shadow-sm hover:bg-primary/90 hover:shadow-md disabled:bg-slate-200 disabled:text-slate-800 disabled:cursor-not-allowed transition-all"
              >
